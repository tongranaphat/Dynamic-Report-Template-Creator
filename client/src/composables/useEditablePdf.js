...
export function useEditablePdf() {
    ...
    const generateHybridPdfBlob = async (
        ...
        try {
            ...
            // 📌 เปิดระบบ Form เพื่อให้ Acrobat พิมพ์แก้ไขได้
            ...
            for (let pi = 0; pi < numPages; pi++) {
                ...
                for (const [objIndex, obj] of pageData.objects.entries()) {
                    ...
                    if (isText) {
                        ...
                        // ==========================================
                        // 📌 โหมด Vector: ใช้ drawText ฝังฟอนต์เต็ม (subset: false) 
                        // เพื่อให้เครื่องมือ "Edit PDF" ใน Acrobat แก้ไขข้อความได้
                        // ==========================================
                        ...
                        for (const line of textLines) {
                            ...
                            try {
                                ...
                                // กรณีฟอนต์มีปัญหา ให้ Fallback กลับไปใช้ Sarabun เสมอ
                                try {
    ...
    // ==========================================
    // 📌 Helper Functions กลับมาครบถ้วนแล้ว!
    // ==========================================
